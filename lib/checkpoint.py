...
SUPPLEMENTARY_ARTIFACTS = {
    ...
    "editable_timeline",    # Renderer-neutral project for human/agent round-trip editing
    "campaign_plan",        # Approved modular creative and delivery matrix
    "batch_run",            # Resumable campaign execution state and QA
    "hook_candidates",      # Need-driven hooks scored before script approval
    "visual_match",         # Scene intent mapped to sourced/generated candidates
    "dialogue_script",      # Speaker-turn contract for synthetic conversations
    "cast_bible",           # Stable host identity, voice, role, and framing rules
    "audio_timeline",       # Audio-first timing truth for dialogue and captions
    "source_transcript",    # Provider-neutral source word timing for raw-footage edits
    "cut_qa_report",        # Decode, audio, and cut-boundary verification evidence
}

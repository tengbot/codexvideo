...
roles can explore. Record the viewer's underlying need, likely objections, and
the facts or visible evidence that resolve them. Keep each claim traceable to a
source and distinguish first-party facts from inference.

Reject topics that require the hosts to manufacture outrage or pretend to have

...
visual information every 1.5-4 seconds. For every scene write:

- narration and evidence reference;
- visual intent, not just search keywords;
- preferred asset type and acceptable fallback;
- composition, motion, duration, transition, and caption-safe region;
- whether the shot proves, explains, contrasts, or releases tension.

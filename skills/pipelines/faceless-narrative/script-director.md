...
1. Hook: immediate tension or question.
2. Setup: name the viewer's situation without product-owner language.
3. Development: two or three specific facts, examples, or contrasts.
4. Reveal: the useful conclusion or decision rule.
5. Landing: a restrained CTA or open loop.

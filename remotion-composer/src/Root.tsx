...
import { VideoChatFaceless, VideoChatPodcast } from "./VideoChatFormats";
import { VibeAhaPodcast } from "./VibeAhaPodcast";
import { VibeAhaShotcraft, VIBEAHA_SHOTCRAFT_FRAMES } from "./VibeAhaShotcraft";
...
export const Root: React.FC = () => {
  return (
    <>
      <Composition
        id="VideoChatFaceless"
        component={VideoChatFaceless}
      ...
      <Composition
        id="VibeAhaShotcraft"
        component={VibeAhaShotcraft}
        durationInFrames={VIBEAHA_SHOTCRAFT_FRAMES}
        fps={30}
        width={720}
        height={1280}
      />
